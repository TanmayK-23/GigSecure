...
import { Shield, Calendar, ChevronRight, Info, CheckCircle, Zap } from 'lucide-react';
import { useAuth } from '../../contexts/AuthContext';
import { usePolicy } from '../../contexts/PolicyContext';
import { useI18n } from '../../contexts/I18nContext';
import { calcPremium, MOCK_CLAIMS, TRIGGER_ICONS } from '../../utils/mockData';
  ...
  if (success) return (
    <div className="modal-overlay">
      <div className="modal-box text-center">
        ...
        <p className="text-muted mb-4">Your coverage is now active. You're protected!</p>
  ...
  return (
    <div>
      <div className="page-content" style={{ maxWidth: 700 }}>
        <h2 className="mb-6">{t('active_policy')}</h2>
      ...
      {showPayment && (
        <PaymentSheet premium={premium.total} onPay={handlePaid} onClose={() => setShowPayment(false)} />
      )}
    </div>
  );
}
